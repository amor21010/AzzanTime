...
//blue only theme
val darkGrayColor= Color(0xffB9BED1)
val grayColor= Color(0xffE3E8F0)
val lightGrayColor= Color(0xffF0F2F7)
val blueColor= Color(0xff3B55E6)

//
val tealColor= Color(0xff106881)
/*val blueColor= Color(0xff3B55E6)
val blueColor= Color(0xff3B55E6)
val blueColor= Color(0xff3B55E6)*/
...
val BlueMain = Color(0xff1e88e5)
val BlueDark = Color(0xff0d47a1)
val OrangeMain = Color(0xffe57b1e)
val YellowMain = Color(0xfff1d03c)
val FuchsiaMain = Color(0xffe51e88)
val FuchsiaDark = Color(0xffbc0067)


val GreyMain = Color(0xFFF8F8F8)
val GreyDark = Color(0xff2e2e2e)


val WhiteMain = Color(0xffffffff)
val GrayMain = Color(0xFFF0F0F0)
